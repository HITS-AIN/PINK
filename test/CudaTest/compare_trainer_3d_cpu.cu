...
//     ,TrainerCompare3DTestData(2,   2,   2,   2,   4, false)
//     ,TrainerCompare3DTestData(2,   2,   2,   2,   8, false)
//     ,TrainerCompare3DTestData(2,   2,   2,   2,   1,  true)
//     ,TrainerCompare3DTestData(2,   2,   2,   2,   4,  true)
//     ,TrainerCompare3DTestData(2,   2,   2,   2,   8,  true)
//     ,TrainerCompare3DTestData(2,   4,   4,   4,   1, false)
//     ,TrainerCompare3DTestData(2,   2,   4,   4,   1, false)
//     ,TrainerCompare3DTestData(2,  64,  45,  45, 360,  true)
//     ,TrainerCompare3DTestData(2,  64, 100, 100, 360,  true)
//     ,TrainerCompare3DTestData(2,  64, 100,  45, 360,  true)
//     ,TrainerCompare3DTestData(2, 124,  91,  64, 360,  true)
//     ,TrainerCompare3DTestData(2,   4,   2,   2,   1, false)
//     ,TrainerCompare3DTestData(2,   4,   2,   2,   8, false)
//     ,TrainerCompare3DTestData(2,   4,   2,   2,   1,  true)
//     ,TrainerCompare3DTestData(2,   4,   2,   2,   8,  true)
));
