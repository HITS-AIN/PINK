...
INSTANTIATE_TEST_CASE_P(MapperTest_all, MapperTest,
    ::testing::Values(
        ...
        MapperTestData(1, 2, 2, 2,   1, false, 0.0, 1.0, {4.0}),
        MapperTestData(1, 3, 3, 2,   1, false, 0.0, 1.0, {4.0}),
        MapperTestData(1, 3, 5, 2, 360, false, 0.0, 1.0, {4.0}),
        MapperTestData(2, 3, 5, 2, 360, false, 0.0, 1.0, {4.0, 4.0, 4.0, 4.0}),
        MapperTestData(2, 3, 5, 2, 360,  true, 0.0, 1.0, {4.0, 4.0, 4.0, 4.0}),
        MapperTestData(2, 3, 5, 2, 360,  true, 0.0, 1.0, {4.0, 4.0, 4.0, 4.0}),
        MapperTestData(1, 2, 2, 2,   1, false, 1.0, 0.0, {4.0}),
        MapperTestData(1, 3, 3, 2,   1, false, 1.0, 0.0, {4.0}),
        MapperTestData(1, 3, 5, 2, 360, false, 1.0, 0.0, {4.0}),
        MapperTestData(2, 3, 5, 2, 360, false, 1.0, 0.0, {4.0, 4.0, 4.0, 4.0}),
        MapperTestData(2, 3, 5, 2, 360,  true, 1.0, 0.0, {4.0, 4.0, 4.0, 4.0}),
        MapperTestData(2, 3, 5, 2, 360,  true, 1.0, 0.0, {4.0, 4.0, 4.0, 4.0}),
