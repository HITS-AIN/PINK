...
TEST(SelfOrganizingMapTest, trainer_num_rot)
{
    ...
    EXPECT_THROW(MyTrainer(som, f, 0, -4, false, neuron_dim, 1.0, Interpolation::BILINEAR), std::runtime_error);
    EXPECT_THROW(MyTrainer(som, f, 0, -1, false, neuron_dim, 1.0, Interpolation::BILINEAR), std::runtime_error);
    EXPECT_THROW(MyTrainer(som, f, 0,  0, false, neuron_dim, 1.0, Interpolation::BILINEAR), std::runtime_error);
    EXPECT_THROW(MyTrainer(som, f, 0, 90, false, neuron_dim, 1.0, Interpolation::BILINEAR), std::runtime_error);
